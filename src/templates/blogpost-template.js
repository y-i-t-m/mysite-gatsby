...
export default ({ data, pageContext, location }) => (
  <Layout>
    <SEO
      ...
      blogimg={`https:${data.contentfulBlogPost.thumbnail.file.url}`}
      pageimgw={data.contentfulBlogPost.thumbnail.file.details.image.width}
      pageimgh={data.contentfulBlogPost.thumbnail.file.details.image.height}
    />
    <div className="eyecatch">
      <figure>
        <Img
          fluid={data.contentfulBlogPost.thumbnail.fluid}
          alt={data.contentfulBlogPost.thumbnail.description}
        />
      </figure>
    </div>
